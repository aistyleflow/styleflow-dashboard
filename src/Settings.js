...
export default Settingimport { useEffect, useState } from 'react'
import { supabase } from './supabase.js'
...
function Settings({ owner }) {
  ...
  async function fetchSettings() {
    try {
      ...
      if (data) {
        // ✅ Change 2 — added logo_url to setForm
        setForm({
          shop_name:    data.shop_name    || '',
          owner_name:   data.owner_name   || '',
          phone_number: data.phone_number || '',
    ...
    <div style={styles.container}>
      ...
      <div style={styles.usageCard}>
        ...
        {usageLoading ? (
          ...
          <div style={styles.usageEmpty}>
            <p style={styles.usageEmptyText}>📭 No usage data yet.</p>
            <p style={styles.usageEmptySubText}>
              Data will appear here once customers start messaging your store.
            </p>
          </div>
      ...
      <div style={styles.formBox}>
        ...
        <div style={styles.formField}>
          ...
          />
          <p style={styles.hint}>
            Paste a direct image link for your store logo.
          </p>
...
const styles = {
  ...
  // ✅ Change 5 — logo preview styles added
  logoPreviewBox: {
    marginTop: '10px',
    padding: '12px',
    backgroundColor: '#f9f9f9',
